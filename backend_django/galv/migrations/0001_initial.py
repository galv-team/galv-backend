# Generated by Django 4.1.4 on 2023-12-06 14:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_properties', models.JSONField(default=dict)),
        ...
        migrations.AddField(
            model_name='team',
            name='admin_group',
            field=models.OneToOneField(help_text='Users authorised to make changes to the Team', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='editable_team', to='galv.groupproxy'),
        ),
        migrations.AddField(
            model_name='team',
            name='lab',
            field=models.ForeignKey(help_text='Lab to which this Team belongs', on_delete=django.db.models.deletion.CASCADE, related_name='teams', to='galv.lab'),
        ),
        migrations.AddField(
            model_name='team',
            name='member_group',
            field=models.OneToOneField(help_text="Users authorised to view this Team's Experiments", null=True, on_delete=django.db.models.deletion.CASCADE, related_name='readable_team', to='galv.groupproxy'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='lab',
            field=models.ForeignKey(help_text='Lab to which this Harvester belongs', on_delete=django.db.models.deletion.CASCADE, related_name='harvesters', to='galv.lab'),
        ),
        migrations.CreateModel(
            name='Experiment',
            fields=[
        ...
        migrations.AddField(
            ...
            name='file',
            field=models.ForeignKey(help_text='File in which this Column appears', on_delete=django.db.models.deletion.CASCADE, related_name='columns', to='galv.observedfile'),
        ),
        migrations.AddField(
            model_name='datacolumn',
            name='type',
            field=models.ForeignKey(help_text='Column Type which this Column instantiates', on_delete=django.db.models.deletion.CASCADE, to='galv.datacolumntype'),
        ),
        migrations.AddField(
            model_name='cyclertest',
            name='equipment',
            field=models.ManyToManyField(help_text='Equipment used to test the cell', related_name='cycler_tests', to='galv.equipment'),
        ),
        migrations.AddField(
            model_name='cyclertest',
            name='file',
            field=models.ManyToManyField(help_text='Columns of data in the test', related_name='cycler_tests', to='galv.observedfile'),
        ),
        migrations.AddField(
            model_name='cyclertest',
            name='schedule',
            field=models.ForeignKey(blank=True, help_text='Schedule used to test the cell', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cycler_tests', to='galv.schedule'),
        ),
        migrations.AddField(
            model_name='cyclertest',
            name='team',
        ...
        migrations.AddField(
            model_name='cell',
            name='family',
            field=models.ForeignKey(help_text='Cell type', on_delete=django.db.models.deletion.CASCADE, related_name='cells', to='galv.cellfamily'),
        ),
        migrations.AddField(
            model_name='cell',
            name='team',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['content_type', 'object_id'], name='galv_schema_content_a0f28a_idx'),
        ),
        migrations.AddIndex(
            model_name='schemavalidation',
            index=models.Index(fields=['status'], name='galv_schema_status_b04295_idx'),
        ),
        migrations.AddIndex(
            model_name='schemavalidation',
            index=models.Index(fields=['schema'], name='galv_schema_schema__f5b262_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='observedfile',
